              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="post">
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" name="sub" style="border: none;">Log
                      in</button>
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a href="sign_up_form.php"><button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger" style="margin-left: 10px;">Create new</button></a>
                  </div>
...
if(isset($_POST['sub']))
{
    ...
    $query = "Select * from login_data where user_name = '$username' and password = '$password'";
